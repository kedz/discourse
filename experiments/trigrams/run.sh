...
#python train_models.py -train $APWS_TRAIN -dev $APWS_DEV -test $APWS_TEST -od models/apws_models -l perceptron -lf 01 -inf gurobi -n 2 -dbg
python train_models.py -train $APWS_TRAIN -dev $APWS_DEV -test $APWS_TEST -od models/apws_models -l perceptron -lf 01 -inf beam -n 2 -dbg
#python train_models.py -train $APWS_TRAIN -dev $APWS_DEV -test $APWS_TEST -od models/apws_models -l perceptron -lf 01 -inf gurobi -n 2 
python train_models.py -train $APWS_TRAIN -dev $APWS_DEV -test $APWS_TEST -od models/apws_models -l perceptron -lf 01 -inf beam -n 2 
python train_models.py -train $APWS_TRAIN -dev $APWS_DEV -test $APWS_TEST -od models/apws_models -l perceptron -lf 01 -inf beam -n 2 -t $CS_DIR/apws


python train_models.py -train $APWS_TRAIN -dev $APWS_DEV -test $APWS_TEST -od models/apws_models -l perceptron -lf 01 -inf beam -n 3
python train_models.py -train $APWS_TRAIN -dev $APWS_DEV -test $APWS_TEST -od models/apws_models -l perceptron -lf 01 -inf beam -n 3 -t $CS_DIR/apws
...
#python train_models.py -train $APWS_TRAIN -dev $APWS_DEV -test $APWS_TEST -od models/apws_models3 -l perceptron -lf 01 -inf glpk -n 3
